...
from PALSYN.models.gru import build_gru_model

from .base import BaseSynthesizer


class GRUSynthesizer(BaseSynthesizer):
    MODEL_TYPE = "GRU"
    ...
    def __init__(
        ...
        *,
        ...
        """Initialize a differential privacy-aware GRU synthesizer."""
    ...
    def _build_model_impl(self) -> tuple[tf.keras.Model, list[str]]:
        model, modified_columns = build_gru_model(
