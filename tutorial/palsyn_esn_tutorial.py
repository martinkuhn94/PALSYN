...
from PALSYN.synthesizer import ESNSynthesizer
...
MODEL_DIR = TUTORIAL_ROOT / "esn_model"
...
#    - model: training hyperparameters + ESN architecture choices.
...
loaded_model = ESNSynthesizer.load(str(MODEL_DIR))
...
xes_filename = TUTORIAL_ROOT / "road_fines_esn_e=15.xes"
...
synthetic_event_df.to_excel(TUTORIAL_ROOT / "road_fines_esn_e=15.xlsx", index=False)
